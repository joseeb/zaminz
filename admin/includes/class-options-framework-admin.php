...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Theme Options', 'html5blank'),
			'menu_title' => __( 'Theme Options', 'html5blank'),
	...
	function enqueue_admin_styles( $hook ) {
		...
		wp_enqueue_style( 'optionsframework', get_template_directory_uri() . '/admin/css/optionsframework.css', array(),  Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'options-custom', get_template_directory_uri() . '/admin/js/options-custom.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION );
